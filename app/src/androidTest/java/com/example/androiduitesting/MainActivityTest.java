...
public class MainActivityTest {
    ...
    /**
     * Click on the Add City Button and enter the name of the city and then we will check if that city is displayed.
    ...
    /**
     * Add cities and then click on Clear All button.
     * If the cities displayed are removed then test should pass else it should fail
     */
    @Test
    ...
    public void testListView() {
        ...
        // Check if in the Adapter view (given id of that adapter view), there is a data (String) at position 0
